...
void metering_cluster_add_to_endpoint(metering_cluster_t *cluster,
    ...
    SETUP_ATTR(0, ZCL_ATTR_METERING_CURRENT_SUMMATION_DELIVERED, ZCL_DATA_TYPE_UINT48,   ATTR_READONLY, cluster->current_summation_delivered);
    SETUP_ATTR(1, ZCL_ATTR_METERING_STATUS,                      ZCL_DATA_TYPE_BITMAP8,  ATTR_READONLY, cluster->status);
    SETUP_ATTR(2, ZCL_ATTR_METERING_UNIT_OF_MEASURE,             ZCL_DATA_TYPE_ENUM8,    ATTR_READONLY, cluster->unit_of_measure);
    SETUP_ATTR(3, ZCL_ATTR_METERING_MULTIPLIER,                  ZCL_DATA_TYPE_UINT24,   ATTR_READONLY, cluster->multiplier);
    SETUP_ATTR(4, ZCL_ATTR_METERING_DIVISOR,                     ZCL_DATA_TYPE_UINT24,   ATTR_READONLY, cluster->divisor);
    SETUP_ATTR(5, ZCL_ATTR_METERING_SUMMATION_FORMATTING,        ZCL_DATA_TYPE_BITMAP8,  ATTR_READONLY, cluster->summation_formatting);
    SETUP_ATTR(6, ZCL_ATTR_METERING_METERING_DEVICE_TYPE,        ZCL_DATA_TYPE_BITMAP8,  ATTR_READONLY, cluster->metering_device_type);
